...
const zh: TranslationKeys = {
  ...
  issues: {
    ...
    allAssignees: '所有负责人',
    allProjects: '所有项目',
    assignedToAgent: '已指派给智能体',
    assignedToMember: '已指派给成员',
    // 表单字段
    titleLabel: '标题',
    ...
    selectAll: '全选',
    deselectAll: '取消全选',
    batchChangeStatus: '更改状态',
    batchChangePriority: '更改优先级',
    batchDelete: '删除所选',
    batchActionSuccess: '议题更新成功',
    batchDeleteConfirm: '删除 {count} 个所选议题？',
    batchDeleteDesc: '此操作不可撤销。',
    // 实时更新
    issueUpdatedLive: '议题已实时更新',
    // 项目分解
    backlog: '待办池',
    todo: '待办',
    active: '进行中',
  ...
  inbox: {
    ...
    archiveAll: '全部归档',
    noUnread: '全部已读！',
    noUnreadDesc: '你没有未读通知',
    noNotifications: '暂无通知',
    noNotificationsDesc: '你的收件箱是空的',
    all: '全部',
    unread: '未读',
    archived: '已归档',
    today: '今天',
  ...
  myIssues: {
    title: '我的议题',
    subtitle: '分配给你的议题',
    noIssuesAssigned: '没有分配给你的议题',
    noIssuesAssignedDesc: '分配给你的议题将显示在这里',
  },
  ...
  autopilots: {
    title: '自动驾驶',
    subtitle: '自动化定期智能体任务',
    createAutopilot: '创建自动驾驶',
    noAutopilots: '暂无自动驾驶',
    noAutopilotsDesc: '创建自动驾驶来自动化定期任务',
    name: '名称',
    namePlaceholder: '例如：每日站会总结',
    description: '描述',
    descriptionPlaceholder: '这个自动驾驶做什么？',
    agent: '智能体',
    selectAgent: '选择智能体',
    chooseAgent: '选择智能体...',
    trigger: '触发器',
    ...
    deactivate: '停用',
    activate: '激活',
    deleteAutopilot: '删除自动驾驶',
    deleteAutopilotDesc: '确定要删除 "{name}" 吗？',
    runHistory: '运行历史',
    noRunHistory: '暂无运行记录',
    createAutopilotTitle: '创建自动驾驶',
    createAutopilotDesc: '配置一个新的自动驾驶来自动化任务',
  },

  // ==================== 运行时视图 ====================
  runtimes: {
    title: '运行时',
    subtitle: '已连接的智能体运行时环境',
    noRuntimes: '暂无已连接的运行时',
    noRuntimesDesc: '智能体运行时连接后将显示在这里。请启动守护进程服务开始。',
    noRuntimesStep1: '1. 启动守护进程迷你服务以模拟运行时连接',
    noRuntimesStep2: '2. 守护进程将自动注册 Claude、Codex 和 Gemini 的模拟运行时',
    noRuntimesStep3: '3. 每 15 秒发送心跳以保持运行时在线',
    online: '在线',
    recentlyLost: '最近断开',
    offline: '离线',
    aboutToGC: '即将回收',
    ...
    deviceInfo: '设备信息',
    deleteRuntime: '删除运行时',
    deleteRuntimeDesc: '确定要删除此运行时记录吗？',
    secondsAgo: (n: number) => `${n}秒前`,
    minutesAgo: (n: number) => `${n}分钟前`,
    hoursAgo: (n: number) => `${n}小时前`,
    daysAgo: (n: number) => `${n}天前`,
    never: '从未',
    daemonUuid: '守护进程 UUID',
    servingAgent: '服务智能体',
    runningTasks: '运行中的任务',
    noRunningTasks: '当前没有运行中的任务',
    connectDaemon: '连接守护进程',
    daemonInstructions: '启动守护进程服务以注册运行时环境',
    daemonUrl: '守护进程健康检查',
    daemonStatus: '守护进程状态',
    connected: '已连接',
    disconnected: '未连接',
  ...
  members: {
    ...
    joinedAt: '加入时间',
    removeMember: '移除成员',
    removeMemberDesc: '确定要将 {name} 从此工作区移除吗？',
    changeRole: '更改角色',
    inviteMemberTitle: '邀请成员',
    inviteMemberDesc: '发送邀请加入此工作区',
    sendInvite: '发送邀请',
    inviteSent: '邀请已发送！',
    ownerOnly: '只有工作区所有者可以执行此操作',
  },
  ...
  settings: {
    ...
    workspaceSlug: '工作区标识',
    workspaceSlugDesc: '用于 URL 和标识符',
    workspaceDesc: '描述',
    workspaceDescPlaceholder: '描述你的工作区...',
    workspaceIcon: '图标',
    workspaceIconDesc: '一个表情符号或短文本来代表你的工作区',
